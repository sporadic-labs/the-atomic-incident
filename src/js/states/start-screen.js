...
StartScreen.prototype.create = function() {
  ...
  this.bg = this.add.tileSprite(0, 0, 2000, 2000, "assets", "hud/grid", this.groups.background);
  ...
  var playBtn = this.game.add.button(
    this.world.centerX,
    this.world.centerY + 20,
    "assets",
    this._playTheGame,
    this,
    "startScreen/play-down",
    "startScreen/play-up"
  );
  playBtn.anchor.setTo(0.5, 0.5);
  this.groups.midground.add(playBtn);
  var optionsBtn = this.game.add.button(
    this.world.centerX,
    this.world.centerY + 140,
    "assets",
    this._options,
    this,
    "startScreen/options-down",
    "startScreen/options-up"
  );
