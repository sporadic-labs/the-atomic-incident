...
export default class LoadState extends Phaser.State {
    preload() {
        ...
        this.load.atlasJSONHash("glowing-light", `${atlasPath}/glowing-light.png`, 
            `${atlasPath}/glowing-light.json`);
        this.load.atlasJSONHash("echo-light", `${atlasPath}/echo-light.png`, 
            `${atlasPath}/echo-light.json`);
        this.load.atlasJSONHash("rotating-light", `${atlasPath}/rotating-light.png`, 
        ...
        const audioFiles = ["pop.mp3", "whoosh.mp3", "whoosh-2.mp3", "warp.mp3", "warp-2.mp3", 
            "impact.mp3", "impact-2.mp3", "smash.mp3"];
        ...
        this.loadingText = this.add.text(this.world.centerX, this.world.centerY, "0%", { 
            font: "200px Arial", fill: "#000", align: "center" 
        });
