        ...
        enemyGroups: [
            {
                ...
                wave: new PathTweenWave(g, {speed: 150, paths: ["paths-top:+1:odd"]})
            }, {
                time: 1,
                composition: new Composition({red: 20, shield: null}),
                wave: new PathTweenWave(g, {speed: 150, paths: ["paths-top:+1:even"]})
            }, {
                time: 6, // Time relative to the start of the wave
                composition: new Composition({red: 20, shield: null}),
                wave: new PathTweenWave(g, {speed: 150, paths: ["paths-bottom:-1:even"]})
            }, {
                time: 7,
                composition: new Composition({red: 20, shield: null}),
                wave: new PathTweenWave(g, {speed: 150, paths: ["paths-bottom:-1:odd"]})
            }
        ]
    })
    .addWaveDelay(10)
        ...
        enemyGroups: [
            {
                ...
                wave: new PathTweenWave(g, {speed: 150, paths: ["paths-left:+1:odd"]})
            }, {
                time: 1,
                composition: new Composition({blue: 20, shield: null}),
                wave: new PathTweenWave(g, {speed: 150, paths: ["paths-left:+1:even"]})
            }, {
                time: 6, // Time relative to the start of the wave
                composition: new Composition({green: 20, shield: null}),
                wave: new PathTweenWave(g, {speed: 150, paths: ["paths-right:-1:even"]})
            }, {
                time: 7,
                composition: new Composition({green: 20, shield: null}),
                wave: new PathTweenWave(g, {speed: 150, paths: ["paths-right:-1:odd"]})
            }
        ]
    })
    .addWaveDelay(10)
