      ...
      enemyGroups: [
        {
          ...
          wave: new PathTweenWave(g, {
            speed: 150,
            paths: ["paths-top-even:+1", "paths-top-odd:+1"]
          })
        },
        {
          time: 5,
          ...
          wave: new PathTweenWave(g, {
            speed: 150,
            paths: ["paths-bottom-even:+1", "paths-bottom-odd:+1"]
          })
        }
      ]
    })
