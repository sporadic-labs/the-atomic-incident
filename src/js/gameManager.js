// define the game manager module

// *** Things to research
//			- What is 'use strict' for?

define('gameManager', ['phaser', 'player'], function (Phaser, Player) { 
	// 'use strict';

  console.log('Function : GameManager');
  ...
  GameManager.prototype = {
    ...
    start: function() {
			var game = new Phaser.Game(600, 600, Phaser.AUTO, 'the-game-area');

			// attach the GameManager to our game as a state
			game.state.add('Game', GameManager, true);
		...
		preload: function() {
			...
			this.load.image('reticule', 'img/reticule.png');
		},
