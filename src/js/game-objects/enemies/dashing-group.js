...
DashingGroup.prototype = Object.create(Phaser.Group.prototype);
DashingGroup.prototype.constructor = DashingGroup;

function DashingGroup(game, numToSpawn, x, y, enemiesGroup, target, 
    scoreSignal) {
    ...
    for (var i = 0; i < numToSpawn; i += 1) {
        ...
        new DashingEnemy(game, enemyX, enemyY, this, i, target, scoreSignal);
    }
...
DashingGroup.prototype.countNeighborsInRange = function (enemy, range) {
    var numInRange = 0;
...
DashingGroup.prototype.getNearestCentroid = function (enemy, numEnemies) {
    var distances = [];
    for (var i = 0; i < this.children.length; i += 1) {
        var otherEnemy = this.children[i];
...
DashingGroup.prototype._calculateDistances = function () {
    this._distances = {};
    for (var i = 0; i < this.children.length; i += 1) {
...
DashingGroup.prototype._getDistanceKey = function (enemy1, enemy2) {
...
DashingGroup.prototype.update = function () {
    this._calculateDistances();
...
DashingEnemy.prototype = Object.create(BaseEnemy.prototype);
DashingEnemy.prototype.constructor = DashingEnemy;

function DashingEnemy(game, x, y, parentGroup, id, target, scoreSignal) {
 ...
 * by a frame.
 */
DashingEnemy.prototype.preUpdate = function() {
...
DashingEnemy.prototype._startCooldown = function() {
...
DashingEnemy.prototype._nextState = function() {
...
DashingEnemy.prototype.getId = function () {
    return this._id;
};

DashingEnemy.prototype.destroy = function() {
