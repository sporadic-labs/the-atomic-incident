...
function ShadowBomber(game, x, y, parentGroup, color) {
  BaseEnemy.call(this, game, x, y, "assets", "enemies/bomber-idle-01", 200, parentGroup, 1, color);
  ...
  this.body.angularVelocity = this.game.rnd.sign() * this.game.rnd.realInRange(25, 35);
}
