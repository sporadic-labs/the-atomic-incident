class Effects extends Phaser.Plugin {
  ...
  lightFlash(color) {
    ...
    this._tween = this.game.add
      .tween(this._fxGraphics)
      .to({ alpha: 0.9 }, 20, Phaser.Easing.Quadratic.In, false, 50)
      .to({ alpha: 0.5 }, 150, Phaser.Easing.Linear.None, false)
      .to({ alpha: 0 }, 800, Phaser.Easing.Quadratic.Out, false)
      .start();
  }
